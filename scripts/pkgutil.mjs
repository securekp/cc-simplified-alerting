 ...
 *
 * Kept byte-identical to the Cribl-Community reference implementation, so a fix made
 * to the org's build scripts can be dropped in without reconciling a local variant.
 */
